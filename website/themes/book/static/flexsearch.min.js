...
;(function (K, R, w) {
  ...
  (function ma(K) {
    ...
    function L(a, c, b, d) {
      this.u !== this.g &&
        ((this.o = this.o.concat(b)),
        this.u++,
        d && this.o.length >= d && (this.u = this.g),
        this.u === this.g &&
          (this.cache && this.j.set(c, this.o), this.F && this.F(this.o)))
      return this
    }
    function S(a) {
      const c = B()
    ...
    function fa(a, c, b) {
      Object.defineProperty(a, c, { get: b })
    }
    function r(a) {
    ...
    function T(a, c, b) {
      return a ? { page: a, next: c ? "" + c : null, result: b } : b
    }
    function ha(a, c, b, d, e, f, h) {
      ...
      if (1 < p) {
        ...
        let D,
          ...
          ea
        l &&
          (2 === l.length ? ((X = l), (l = !1)) : (l = ea = parseInt(l[0], 10)))
        if (h) {
          for (v = B(); n < p; n++)
            if ("not" === e[n])
        ...
        if (d)
          for (
            E = k.length,
              X
                ? ((n = parseInt(X[0], 10) + 1), (m = parseInt(X[1], 10) + 1))
                : ((n = t.length), (m = 0));
            n--;
        ...
        !p ||
          (e && "not" === e[0]) ||
          ((k = a[0]), l && (l = parseInt(l[0], 10)))
      c &&
        ((h = k.length),
        l && l > h && (l = 0),
        (l = l || 0),
        (g = l + c),
        g < h ? (k = k.slice(l, g)) : ((g = 0), l && (k = k.slice(l))))
      return T(b, g, k)
    }
    function J(a) {
        ...
        if ((b = b.data))
          if (b.search) {
            const d = c.search(
              b.content,
              b.threshold
                ? { limit: b.limit, threshold: b.threshold, where: b.where }
                : b.limit
            )
            self.postMessage({
              id: a,
            ...
            b.add
              ? c.add(b.id, b.content)
              : b.update
              ? c.update(b.id, b.content)
              : b.remove
              ? c.remove(b.id)
              : b.clear
              ? c.clear()
              : b.info
              ? ((b = c.info()), (b.worker = a), console.log(b))
              : b.register &&
                ((a = b.id),
                (b.options.cache = !1),
                (b.options.async = !1),
                ...
                (c = new Function(
                  b.register.substring(
                    b.register.indexOf("{") + 1,
                    b.register.lastIndexOf("}")
                  )
                )()),
                (c = new c(b.options)))
      }
    ...
    function ta(a, c, b, d) {
      a = K(
        ...
        function (f) {
          ;(f = f.data) &&
            f.result &&
            d(f.id, f.content, f.result, f.limit, f.where, f.cursor, f.suggest)
        },
        c
      )
      const e = ma.toString()
      b.id = c
      a.postMessage({ register: e, options: b, id: c })
      return a
    }
    const H = {
        encode: "icase",
    ...
    w.prototype.init = function (a, c) {
      ...
      this.async =
        "undefined" === typeof Promise || C((b = a.async))
          ? this.async || H.async
          : b
      this.g = C((b = a.worker)) ? this.g || H.g : b
      this.threshold = C((b = a.threshold))
        ? c.threshold || this.threshold || H.threshold
        : b
      this.b = C((b = a.resolution)) ? (b = c.b || this.b || H.b) : b
      b <= this.threshold && (this.b = this.threshold + 1)
      this.depth =
        "strict" !== this.f || C((b = a.depth))
          ? c.depth || this.depth || H.depth
          : b
      this.w =
        ((b = C((b = a.encode)) ? c.encode || H.encode : b) &&
          U[b] &&
          U[b].bind(U)) ||
        (O(b) ? b : this.w || !1)
      ...
      if ((b = c || a.stemmer)) {
        ...
        for (g in c)
          c.hasOwnProperty(g) &&
            ((f = d ? d(g) : g), e.push(r(f + "($|\\W)"), d ? d(c[g]) : c[g]))
        this.stemmer = g = e
      }
      ...
      if (e) {
        ...
        if (h) {
          var k = B()
          if (J(h)) k[h] = 1
          else if (F(h)) for (let l = 0; l < h.length; l++) k[h[l]] = 1
          else G(h) && (k = h)
          e.store = k
        }
        if (f) {
          ...
          if (d)
            if (J(d)) h[d] = a
            else if (F(d)) for (k = 0; k < d.length; k++) h[d[k]] = a
            else G(d) && (h = d)
          F(f) || (e.tag = f = [f])
        ...
        if (d) {
          ...
          F(d) ||
            (G(d)
              ? ((l = d), (e.field = d = Object.keys(d)))
              : (e.field = d = [d]))
          for (e = 0; e < d.length; e++)
            (f = d[e]),
              F(f) || (l && (a = l[f]), (c[e] = f), (d[e] = f.split(":"))),
              (g[f] = new w(a))
        }
        a.doc = b
      }
      this.B = !0
      this.j = (this.cache = b = C((b = a.cache)) ? this.cache || H.cache : b)
        ? new ua(b)
        : !1
      return this
    }
    w.prototype.encode = function (a) {
      a &&
        (aa.length && (a = Q(a, aa)),
        this.v.length && (a = Q(a, this.v)),
        this.w && (a = this.w(a)),
        this.stemmer && (a = Q(a, this.stemmer)))
      return a
    }
      ...
      if (c && J(c) && (a || 0 === a)) {
        ...
        if (this.g)
          return (
            ...
            this.m[this.C].postMessage({ add: !0, id: a, content: c }),
            (this.c[f] = "" + this.C),
            b && b(),
            this
          )
            ...
            switch (b) {
              ...
              default:
                if (((g = V(z, n, h, a, 1, k, u, A - 1)), q && 1 < m && g >= u))
                  for (
                    g = n._ctx[h] || (n._ctx[h] = B()),
                      h = this.h[h] || (this.h[h] = ia(A - (u || 0))),
                      k = t - q,
                      l = t + q + 1,
                      0 > k && (k = 0),
                      l > m && (l = m);
                    ...
                    k !== t &&
                      V(h, g, e[k], a, 0, A - (k < t ? t - k : k - t), u, A - 1)
            }
          }
        }
        this.c[f] = 1
    ...
    w.prototype.remove = function (a, c, b) {
      ...
      if (this.c[d]) {
        if (this.g)
          return (
            this.m[this.c[d]].postMessage({ remove: !0, id: a }),
            delete this.c[d],
            c && c(),
            this
          )
    ...
    w.prototype.search = function (a, c, b, d) {
      if (G(c)) {
        if (F(c)) for (var e = 0; e < c.length; e++) c[e].query = a
        else c.query = a
        a = c
        c = 1e3
      ...
      if (this.g) {
        ...
        for (var f = 0; f < this.g; f++)
          this.m[f].postMessage({ search: !0, limit: c, content: a })
      } else {
        var h = [],
          g = a
        if (G(a) && !F(a)) {
        ...
        if (this.a) {
          ...
          for (q = 0; q < n; q++)
            u && (g = u[q]),
              l && !J(g) && ((g.page = null), (g.limit = 0)),
              (h[q] = f[m[q]].search(g, 0))
          ...
          for (; z < u; z++) {
            ...
            if (t) {
              ...
              if (!A[t]) {
                ...
                if (x)
                  (m = t), (e[e.length] = 1 < I ? v.concat.apply([], v) : v[0])
                else if (!p) {
                  d = !1
                  break
                }
      ...
      for (u = 0; u < m; u++) {
        ...
        for (let z = 0; z < n; z++) {
          ...
          const y = k[z],
            t = y.length
          let v = q
          if (1 < t) for (let x = 0; x < t; x++) v = v[y[x]]
          else v = v[y[0]]
          if (v !== c) {
            A = !1
            break
    ...
    w.prototype.info = function () {
      if (this.g)
        for (let a = 0; a < this.g; a++)
          this.m[a].postMessage({ info: !0, id: this.id })
      else
        return {
          id: this.id,
          items: this.length,
    ...
    w.prototype.destroy = function () {
      ...
      if (this.a) {
        const a = this.a.keys
        for (let c = 0; c < a.length; c++) this.a.index[a[c]].destroy()
        this.a = this.l = null
      }
      return this
    }
